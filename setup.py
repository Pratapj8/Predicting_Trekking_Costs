...
def get_requirements(file_path: str) -> List[str]:
    ...
    with open(file_path) as file_obj:  # open the txt file as file_obj
        ...
        ]  # replace the next line with blank(error free)
...
setup(
    ...
    description="A trekking cost prediction ML pipeline project",
    long_description=open("README.md").read(),  # if you have one
